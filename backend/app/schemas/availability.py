...
class TrainerAvailabilityBase(BaseModel):
    ...
    start_time: str = Field(..., regex=r'^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$', description="Start time in HH:MM format")
    end_time: str = Field(..., regex=r'^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$', description="End time in HH:MM format")
