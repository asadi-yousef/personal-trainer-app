        ...
        <div className="p-6">
          ...
          {showOptimalSchedule && optimalScheduleData && (
            <div className="mb-6 bg-green-50 border border-green-200 rounded-lg p-6">
              ...
              {/* Show rejected requests with specific reasons */}
              {optimalScheduleData.rejected_entries && optimalScheduleData.rejected_entries.length > 0 && (
                <div className="mt-4">
                  <h4 className="text-sm font-semibold text-gray-700 mb-2">Rejected Requests (with reasons):</h4>
                  <div className="space-y-2">
                    {optimalScheduleData.rejected_entries.map((entry: any, index: number) => (
                      <div key={index} className="bg-red-50 p-3 rounded-lg border border-red-200">
                        <div className="flex justify-between items-start">
                          <div>
                            <p className="font-medium text-red-800">{entry.client_name}</p>
